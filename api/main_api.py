...
# =====================================================================
# 🔥 HACK SENIOR DE COMPATIBILIDAD (Evita el fallo de quantization_config)
# =====================================================================
try:
    from keras.src.layers.core.dense import Dense
    original_init = Dense.__init__
    def patched_init(self, *args, **kwargs):
        kwargs.pop('quantization_config', None)  # Removemos el intruso si existe
        original_init(self, *args, **kwargs)
    Dense.__init__ = patched_init
except Exception:
    # Si las rutas internas de Keras varían, nos aseguramos que no rompa el script
    pass
# =====================================================================
...
# Carga del modelo en memoria usando la ruta correcta
MODEL_PATH = os.path.join(os.path.dirname(__file__), "../model/model.h5")

try:
    # Ahora sí, Keras va a ignorar ese parámetro fantasma y va a levantar el modelo completo
    model = tf.keras.models.load_model(MODEL_PATH)
    CLASSES = ["Asma", "Epoc", "Neumonia", "Normal"]
    print("🚀 [SUCCESS] ¡Modelo .h5 cargado con éxito en memoria!")
